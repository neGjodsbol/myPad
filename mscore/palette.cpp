...
void Palette::mouseDoubleClickEvent(QMouseEvent* ev)
    ...
    QMessageBox::information(this,"DoubleClick","DoubleClick",QMessageBox::Cancel);
...
void Palette::applyPaletteElement()
      {
#ifdef TABGUI
    QMessageBox::information(this,"apply","apply", QMessageBox::Cancel);
#endif
...
static void paintPaletteElement(void* data, Element* e)
      {
#ifdef TABGUI
    QMessageBox::information(this,"paint","paint",QMessageBox::Cancel);
#endif
